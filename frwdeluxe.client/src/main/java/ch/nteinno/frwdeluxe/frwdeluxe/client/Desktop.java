...
import ch.nteinno.frwdeluxe.frwdeluxe.client.Desktop.UserProfileMenu.ThemeMenu.DarkThemeMenu;
import ch.nteinno.frwdeluxe.frwdeluxe.client.Desktop.UserProfileMenu.ThemeMenu.DefaultThemeMenu;
import ch.nteinno.frwdeluxe.frwdeluxe.client.frwdeluxe.FRWDeluxeOutline;
...
public class Desktop extends AbstractDesktop {
  ...
  public class WorkOutlineViewButton extends AbstractOutlineViewButton {
    ...
    public WorkOutlineViewButton() {
      this(FRWDeluxeOutline.class);
    }

    protected WorkOutlineViewButton(Class<? extends FRWDeluxeOutline> outlineClass) {
